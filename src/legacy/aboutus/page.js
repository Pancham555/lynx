        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="mt-2 text-lg text-gray-600">
              ...
              approach problems from multiple perspectives, leading to creative
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              together, we can overcome any challenge and create a better future
              for all.
            </p>
            <p className="mt-4 text-lg text-gray-600">
              We are dedicated to our values of integrity, excellence, and
              inclusivity. We hold ourselves to the highest standards of ethical
              conduct, constantly striving to improve and innovate. We believe
              that diversity and inclusivity are essential to our success, and
              we are committed to creating a welcoming and supportive
              environment for all team members and partners.
            </p>

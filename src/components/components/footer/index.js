...
const Footer = () => {
  return (
    <div className="flex justify-center">
      <footer className="relative w-full h-full max-w-screen-xl pt-20 pb-10 bg-white border-t lg:pb-20">
        <div className="container mx-auto">
          <div className="flex flex-wrap justify-between mx-4 lg:mx-0">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <div className="mb-6 inline-block max-w-[160px]">
                  <div className="max-w-full text-2xl font-bold">
                    {/* <div className="my-2.5 text-3xl text-theme">Portfolio</div> */}
                    <Image
                      src="/Next Lynx.svg"
                      alt="logo"
                      width={50}
                      height={50}
                      className="w-24 my-2.5"
                    />
                  </div>
                </div>
                ...
                <p className="flex items-center text-sm font-medium text-dark">
                  <span className="mr-3 text-primary flex items-center justify-center">
                    {/* <svg
                      width="19"
                      height="21"
                      viewBox="0 0 19 21"
                  ...
                  <span className="my-auto">panchamb63@gmail.com</span>
                </p>
              </div>
            </div>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
              <div className="w-full mb-10">
                ...
                <ul>
                  <li>
                    <a
                      href="https://tail-blogs.vercel.app"
                      target="_blank"
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  {/* <div className="text-dark hover:bg-primary hover:border-theme mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-theme sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="8"
                      height="16"
                      viewBox="0 0 8 16"
                  ...
                  <a
                    href="https://x.com/pancham_barman"
                    target="_blank"
                    referrerPolicy="no-referrer"
                  >
                    <div className="text-dark hover:bg-primary hover:border-theme mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-theme sm:mr-4 lg:mr-3 xl:mr-4">

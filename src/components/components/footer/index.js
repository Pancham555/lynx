                ...
                >
                  <div className="max-w-full text-2xl font-bold">
                    ...
                    {/* <Image src='/logo.svg' alt="logo"
                      width={50} height={50}
                      className='w-24 my-auto -ml-0' /> */}
                  </div>
                </div>
                <p className="-mt-5 text-base text-body-color mb-7">
                  Your go-to destination for creating a professional and modern website that showcases your brand and captures your audience&apos;s attention.
                </p>
              ...
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <div
                    ...
                    className="text-dark hover:bg-primary hover:border-theme mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-theme sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
                ...
                <p className="text-base text-body-color">&copy; 2023 Next-Site</p>
              </div>
            </div>
          </div>
        </div>
